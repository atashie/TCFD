...
ncpath = "J:\\Cai_data\\TCFD\\ReservoirStorage\\"
	# reading ssp126 climate data 
ncname = 'matsiro_gfdl-esm2m_ewembi_rcp26_2005soc_co2_reservoirstor_global_monthly_2006_2099.nc4'#"clm45_gfdl-esm2m_ewembi_rcp60_2005soc_2005co2_thawdepth_global_annual_2006_2099.nc4"  
...
nc_rStor = ncvar_get(ncin,"reservoirstor")	# lon, lat, time
...
write.csv(rsrvrStorMin_2029, "J:\\Cai_data\\TCFD\\ReservoirStorage\\rsrvrStorMin_MATSIRO_rcp26_2029.csv")
write.csv(rsrvrStorMin_3039, "J:\\Cai_data\\TCFD\\ReservoirStorage\\rsrvrStorMin_MATSIRO_rcp26_3039.csv")
write.csv(rsrvrStorMin_4049, "J:\\Cai_data\\TCFD\\ReservoirStorage\\rsrvrStorMin_MATSIRO_rcp26_4049.csv")
write.csv(rsrvrStorMin_5059, "J:\\Cai_data\\TCFD\\ReservoirStorage\\rsrvrStorMin_MATSIRO_rcp26_5059.csv")
write.csv(rsrvrStorMin_6069, "J:\\Cai_data\\TCFD\\ReservoirStorage\\rsrvrStorMin_MATSIRO_rcp26_6069.csv")
write.csv(rsrvrStorMin_7079, "J:\\Cai_data\\TCFD\\ReservoirStorage\\rsrvrStorMin_MATSIRO_rcp26_7079.csv")
write.csv(rsrvrStorMin_8089, "J:\\Cai_data\\TCFD\\ReservoirStorage\\rsrvrStorMin_MATSIRO_rcp26_8089.csv")
write.csv(rsrvrStorMin_9099, "J:\\Cai_data\\TCFD\\ReservoirStorage\\rsrvrStorMin_MATSIRO_rcp26_9099.csv")
...
image(nc_lon,nc_lat,t(as.matrix(rsrvrStorMin_9099[nrow(rsrvrStorMin_9099):1,])), ylim = c(-57,85),
	col=col5(n=11), breaks = seq(-1000,1000,length.out=12),
