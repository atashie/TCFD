...
data_nc = Dataset('J:/Cai_data/TCFD/GWstorage/watergap2-2c_gfdl-esm2m_ewembi_rcp60_2005soc_co2_groundwstor_global_monthly_2006_2099.nc4')
    # accessing the variables
origLon = data_nc.variables['lon']
origLat = data_nc.variables['lat']
fireint = data_nc.variables['groundwstor']       # note time is in 3 dimensions, lon lat and time



fn = 'j:/Cai_data/TCFD/GWstorage/gwStor_RCP26et60_2020sto2090s_WaterGAP_5May2022.nc'
...
fireint = ds.createVariable('groundwstor', 'f4', ('stYr', 'RCP', 'lat','lon',))
fireint.units = 'kg m-2'
...
data_cs_20 = pd.read_csv('J:/Cai_data/TCFD/GWstorage/GWstorMin_WaterGAP_rcp26_2029.csv')
data_dr_20 = data_cs_20.iloc[:,1:]
data_cs_30 = pd.read_csv('J:/Cai_data/TCFD/GWstorage/GWstorMin_WaterGAP_rcp26_3039.csv')
data_dr_30 = data_cs_30.iloc[:,1:]
data_cs_40 = pd.read_csv('J:/Cai_data/TCFD/GWstorage/GWstorMin_WaterGAP_rcp26_4049.csv')
data_dr_40 = data_cs_40.iloc[:,1:]
data_cs_50 = pd.read_csv('J:/Cai_data/TCFD/GWstorage/GWstorMin_WaterGAP_rcp26_5059.csv')
data_dr_50 = data_cs_50.iloc[:,1:]
data_cs_60 = pd.read_csv('J:/Cai_data/TCFD/GWstorage/GWstorMin_WaterGAP_rcp26_6069.csv')
data_dr_60 = data_cs_60.iloc[:,1:]
data_cs_70 = pd.read_csv('J:/Cai_data/TCFD/GWstorage/GWstorMin_WaterGAP_rcp26_7079.csv')
data_dr_70 = data_cs_70.iloc[:,1:]
data_cs_80 = pd.read_csv('J:/Cai_data/TCFD/GWstorage/GWstorMin_WaterGAP_rcp26_8089.csv')
data_dr_80 = data_cs_80.iloc[:,1:]
data_cs_90 = pd.read_csv('J:/Cai_data/TCFD/GWstorage/GWstorMin_WaterGAP_rcp26_9099.csv')
...
#### RCP 26
# reading in csvs for compilation
data_cs_20 = pd.read_csv('J:/Cai_data/TCFD/GWstorage/GWstorMin_WaterGAP_rcp60_2029.csv')
data_dr_20 = data_cs_20.iloc[:,1:]
data_cs_30 = pd.read_csv('J:/Cai_data/TCFD/GWstorage/GWstorMin_WaterGAP_rcp60_3039.csv')
data_dr_30 = data_cs_30.iloc[:,1:]
data_cs_40 = pd.read_csv('J:/Cai_data/TCFD/GWstorage/GWstorMin_WaterGAP_rcp60_4049.csv')
data_dr_40 = data_cs_40.iloc[:,1:]
data_cs_50 = pd.read_csv('J:/Cai_data/TCFD/GWstorage/GWstorMin_WaterGAP_rcp60_5059.csv')
data_dr_50 = data_cs_50.iloc[:,1:]
data_cs_60 = pd.read_csv('J:/Cai_data/TCFD/GWstorage/GWstorMin_WaterGAP_rcp60_6069.csv')
data_dr_60 = data_cs_60.iloc[:,1:]
data_cs_70 = pd.read_csv('J:/Cai_data/TCFD/GWstorage/GWstorMin_WaterGAP_rcp60_7079.csv')
data_dr_70 = data_cs_70.iloc[:,1:]
data_cs_80 = pd.read_csv('J:/Cai_data/TCFD/GWstorage/GWstorMin_WaterGAP_rcp60_8089.csv')
data_dr_80 = data_cs_80.iloc[:,1:]
data_cs_90 = pd.read_csv('J:/Cai_data/TCFD/GWstorage/GWstorMin_WaterGAP_rcp60_9099.csv')
data_dr_90 = data_cs_90.iloc[:,1:]
