...
ncpath = "J:\\Cai_data\\TCFD\\MaizeRainfed\\"
	# reading ssp126 climate data 
ncname_gfdl = 'lpjml_gfdl-esm2m_ewembi_rcp60_2005soc_co2_pft-mai-rainfed_global_annual_2006_2099.nc4'#"clm45_gfdl-esm2m_ewembi_rcp60_2005soc_co2_burntarea_global_monthly_2006_2099.nc4"  
ncin_gfdl = nc_open(paste0(ncpath, ncname_gfdl))
nc_gfdl = ncvar_get(ncin_gfdl,"pft-mai-rainfed")	# lon, lat, time

ncname_hadgem = 'lpjml_hadgem2-es_ewembi_rcp60_2005soc_co2_pft-mai-rainfed_global_annual_2006_2099.nc4'#"clm45_gfdl-esm2m_ewembi_rcp60_2005soc_co2_burntarea_global_monthly_2006_2099.nc4"  
ncin_hadgem = nc_open(paste0(ncpath, ncname_hadgem))
nc_hadgem = ncvar_get(ncin_hadgem,"pft-mai-rainfed")	# lon, lat, time

ncname_ipsl = 'lpjml_ipsl-cm5a-lr_ewembi_rcp60_2005soc_co2_pft-mai-rainfed_global_annual_2006_2099.nc4'#"clm45_gfdl-esm2m_ewembi_rcp60_2005soc_co2_burntarea_global_monthly_2006_2099.nc4"  
ncin_ipsl = nc_open(paste0(ncpath, ncname_ipsl))
nc_ipsl = ncvar_get(ncin_ipsl,"pft-mai-rainfed")	# lon, lat, time

ncname_miroc = 'lpjml_miroc5_ewembi_rcp60_2005soc_co2_pft-mai-rainfed_global_annual_2006_2099.nc4'#"clm45_gfdl-esm2m_ewembi_rcp60_2005soc_co2_burntarea_global_monthly_2006_2099.nc4"  
ncin_miroc = nc_open(paste0(ncpath, ncname_miroc))
nc_miroc = ncvar_get(ncin_miroc,"pft-mai-rainfed")	# lon, lat, time

nc_lat = ncvar_get(ncin_miroc, 'lat')	# lat is given from high to low
nc_lon = ncvar_get(ncin_miroc, 'lon')
nc_date = as.Date("1661-01-01") + ncvar_get(ncin_miroc, 'time') * 365.25# time is days after 1661-1-1
...
all_data$Hazard = "Maize Productivity (unirrigated)"
...
fwrite(all_data, paste0(ncpath, "maizeProductivityUnirrigated_", "rcp6.0", ".csv"))


	# combining the data
all_data = rbind(fread(paste0(ncpath, "maizeProductivityUnirrigated_", "rcp6.0", ".csv")), fread(paste0(ncpath, "maizeProductivityUnirrigated_", "rcp2.6", ".csv")))
IDcol = data.frame(ID = 1:nrow(all_data))
fwrite(cbind(IDcol, all_data), paste0(ncpath, "maizeProductivityUnirrigated_", "allData_30JUN2022", ".csv"))

all_data = fread(paste0(ncpath, "maizeProductivityUnirrigated_", "allData_30JUN2022", ".csv"))
