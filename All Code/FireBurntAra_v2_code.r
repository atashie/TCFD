...
ncname_gfdl = 'clm45_gfdl-esm2m_ewembi_rcp26_2005soc_co2_burntarea_global_monthly_2006_2099.nc4'#"clm45_gfdl-esm2m_ewembi_rcp60_2005soc_co2_burntarea_global_monthly_2006_2099.nc4"  
ncin_gfdl = nc_open(paste0(ncpath, ncname_gfdl))
nc_gfdl = ncvar_get(ncin_gfdl,"burntarea")	# lon, lat, time

ncname_hadgem = 'clm45_hadgem2-es_ewembi_rcp26_2005soc_co2_burntarea_global_monthly_2006_2099.nc4'#"clm45_gfdl-esm2m_ewembi_rcp60_2005soc_co2_burntarea_global_monthly_2006_2099.nc4"  
ncin_hadgem = nc_open(paste0(ncpath, ncname_hadgem))
nc_hadgem = ncvar_get(ncin_hadgem,"burntarea")	# lon, lat, time

ncname_ipsl = 'clm45_ipsl-cm5a-lr_ewembi_rcp26_2005soc_co2_burntarea_global_monthly_2006_2099.nc4'#"clm45_gfdl-esm2m_ewembi_rcp60_2005soc_co2_burntarea_global_monthly_2006_2099.nc4"  
ncin_ipsl = nc_open(paste0(ncpath, ncname_ipsl))
nc_ipsl = ncvar_get(ncin_ipsl,"burntarea")	# lon, lat, time

ncname_miroc = 'clm45_miroc5_ewembi_rcp26_2005soc_co2_burntarea_global_monthly_2006_2099.nc4'#"clm45_gfdl-esm2m_ewembi_rcp60_2005soc_co2_burntarea_global_monthly_2006_2099.nc4"  
ncin_miroc = nc_open(paste0(ncpath, ncname_miroc))
nc_miroc = ncvar_get(ncin_miroc,"burntarea")	# lon, lat, time
...
all_data$Hazard = "Fire (% Area Burned)"
...
fwrite(all_data, paste0(ncpath, "burntarea_", "rcp2.6", ".csv"))


	# combining the scenarios
all_data = rbind(fread(paste0(ncpath, "burntarea_", "rcp6.0", ".csv")), fread(paste0(ncpath, "burntarea_", "rcp2.6", ".csv")))
IDcol = data.frame(ID = 1:nrow(all_data))
fwrite(cbind(IDcol, all_data), paste0(ncpath, "burntarea_", "allData_30MAY2022", ".csv"))
