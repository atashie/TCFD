...
ncpath = "J:\\Cai_data\\TCFD\\NdlEvrgrnTrDrtolThermo\\"
	# reading ssp126 climate data 
ncname = 'caraib_gfdl-esm2m_ewembi_rcp26_2005soc_co2_npp-ndevtedttht_global_annual_2006_2099.nc4'#"clm45_gfdl-esm2m_ewembi_rcp60_2005soc_co2_burntarea_global_monthly_2006_2099.nc4"  
...
nc_npp = ncvar_get(ncin,"npp-ndevtedttht")	# lon, lat, time
...
write.csv(nppChng_2029, "J:\\Cai_data\\TCFD\\NdlEvrgrnTrDrtolThermo\\nppchng_CARAIB_rcp60_2029.csv")
write.csv(nppChng_3039, "J:\\Cai_data\\TCFD\\NdlEvrgrnTrDrtolThermo\\nppchng_CARAIB_rcp60_3039.csv")
write.csv(nppChng_4049, "J:\\Cai_data\\TCFD\\NdlEvrgrnTrDrtolThermo\\nppchng_CARAIB_rcp60_4049.csv")
write.csv(nppChng_5059, "J:\\Cai_data\\TCFD\\NdlEvrgrnTrDrtolThermo\\nppchng_CARAIB_rcp60_5059.csv")
write.csv(nppChng_6069, "J:\\Cai_data\\TCFD\\NdlEvrgrnTrDrtolThermo\\nppchng_CARAIB_rcp60_6069.csv")
write.csv(nppChng_7079, "J:\\Cai_data\\TCFD\\NdlEvrgrnTrDrtolThermo\\nppchng_CARAIB_rcp60_7079.csv")
write.csv(nppChng_8089, "J:\\Cai_data\\TCFD\\NdlEvrgrnTrDrtolThermo\\nppchng_CARAIB_rcp60_8089.csv")
write.csv(nppChng_9099, "J:\\Cai_data\\TCFD\\NdlEvrgrnTrDrtolThermo\\nppchng_CARAIB_rcp60_9099.csv")
...
image(nc_lon,nc_lat,t(as.matrix(nppChng_9099[nrow(nppChng_9099):1,]))*10000000, ylim = c(-57,85),
	...
	ylab='Lat', xlab = 'lon', main = "Changes Productivity of Temperate Coniferous Forests (2090s - Prev. 20Yrs) RCP2.6")
data(wrld_simpl)
