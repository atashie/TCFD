...
ncpath = "J:\\Cai_data\\TCFD\\BurntAreaCO2\\"
	# reading ssp126 climate data 
ncname = 'clm45_gfdl-esm2m_ewembi_rcp26_2005soc_co2_fireint_global_monthly_2006_2099.nc4'#"clm45_gfdl-esm2m_ewembi_rcp60_2005soc_co2_burntarea_global_monthly_2006_2099.nc4"  
...
nc_burntArea = ncvar_get(ncin,"fireint")	# lon, lat, time
...
write.csv(burntAreaChng_2029, "J:\\Cai_data\\TCFD\\BurntAreaCO2\\BurntAreaCO2chng_CLM45_rcp26_2029.csv")
write.csv(burntAreaChng_3039, "J:\\Cai_data\\TCFD\\BurntAreaCO2\\BurntAreaCO2chng_CLM45_rcp26_3039.csv")
write.csv(burntAreaChng_4049, "J:\\Cai_data\\TCFD\\BurntAreaCO2\\BurntAreaCO2chng_CLM45_rcp26_4049.csv")
write.csv(burntAreaChng_5059, "J:\\Cai_data\\TCFD\\BurntAreaCO2\\BurntAreaCO2chng_CLM45_rcp26_5059.csv")
write.csv(burntAreaChng_6069, "J:\\Cai_data\\TCFD\\BurntAreaCO2\\BurntAreaCO2chng_CLM45_rcp26_6069.csv")
write.csv(burntAreaChng_7079, "J:\\Cai_data\\TCFD\\BurntAreaCO2\\BurntAreaCO2chng_CLM45_rcp26_7079.csv")
write.csv(burntAreaChng_8089, "J:\\Cai_data\\TCFD\\BurntAreaCO2\\BurntAreaCO2chng_CLM45_rcp26_8089.csv")
write.csv(burntAreaChng_9099, "J:\\Cai_data\\TCFD\\BurntAreaCO2\\BurntAreaCO2chng_CLM45_rcp26_9099.csv")
...
image(nc_lon,nc_lat,t(as.matrix(burntAreaChng_9099[nrow(burntAreaChng_9099):1,]))*1000000, ylim = c(-57,85),
	col=rev(col5(n=11)), breaks = c(-1,-0.1,-0.01,-0.001,-0.0002,-0.0001,0.0001,0.0002,0.001,0.01,0.1,1),#seq(-.02,.02,length.out=12),
	ylab='Lat', xlab = 'lon', main = "Changes Wildfire CO2 Emissions (2090s - Prev. 20Yrs) RCP2.6")
data(wrld_simpl)
